...
export const Preloader: React.FC<PreloaderProps> = ({ pathname }) => {
    ...
    switch (path) {
      case '/figma':
        return {
          ...
          title: 'DAVE AGUSTIN CAACOY FIGMA',
      ...
      case '/graphics':
        return {
          ...
          title: 'DAVE AGUSTIN CAACOY GRAPHICS',
      ...
      case '/portfolio':
        return {
          ...
          title: 'DAVE AGUSTIN CAACOY SYSTEMS',
      ...
      default:
        return {
          logs: [
            'SYSTEM STATUS: INIT',
            'DAVE AGUSTIN CAACOY ENGINE: INJECTING... OK',
            'COGNITIVE CORE: ONLINE'
          ],
          title: 'DAVE AGUSTIN CAACOY',
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Glitch effect on the Dave Agustin Caacoy title
      if (titleRef.current) {
