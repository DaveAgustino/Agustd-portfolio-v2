          ...
          <div className="about-top-row">
            ...
            <div className="about-headline-wrap reveal reveal-delay-1">
              ...
              <p className="about-desc">
                I am Dave Agustin Caacoy — a Singapore-based developer, graphics artist, and designer specialized in crafting visually compelling, high-performance digital experiences. With a keen eye for aesthetics and a deep understanding of user behavior, I design and build interfaces that deliver real value, scalable backend architectures, and Web3 integrations.
              </p>
            </div>
          </div>
