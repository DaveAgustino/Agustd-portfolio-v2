  ...
  return (
    ...
    >
      <nav className="site-nav" aria-label="Main navigation">
        <Link to="/" className="site-logo" aria-label="Dave Agustin Caacoy — Home" onClick={closeMobileMenu}>
          <img src="/images/logo.png" alt="Dave Agustin Caacoy" className="header-logo-img" />
        </Link>
